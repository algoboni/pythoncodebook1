...
9. pg 117~118: 코드 상의 "표본 크기"를 "표본 규모로 수정한다.
10. pg 379: 다음의 코드 블럭 실행 결과를 추가한다. "log: ADF p-value 0.001, KPSS p-value 0.100, box-cox: ADF p-value 0.000, KPSS p-value 0.100"
